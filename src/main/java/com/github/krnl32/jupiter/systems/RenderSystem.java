...
public class RenderSystem implements System {
	...
	public void onRender(float dt, Renderer renderer) {
		for (Entity entity: registry.getEntitiesWith(TransformComponent.class, SpriteRendererComponent.class)) {
			...
			renderer.submit(new RenderSpriteCommand(transform.translation, new SpriteRenderData(transform.scale.x, transform.scale.y, spriteRenderer.index, spriteRenderer.color, texture)));
		}
	}
}
