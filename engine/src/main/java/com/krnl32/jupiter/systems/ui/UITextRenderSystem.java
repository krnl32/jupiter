...
public class UITextRenderSystem implements System {
	...
	public void onRender(float dt, Renderer renderer) {
		for (Entity entity : registry.getEntitiesWith(UITransformComponent.class, UITextComponent.class)) {
			...
			// Parent Bound/Border
			float posX = transform.translation.x;
			float posY = transform.translation.y;
