package com.krnl32.jupiter.engine.serializer.oldcomponents.input;
...
public class KeyboardControlComponentSerializer implements OldComponentSerializer<KeyboardControlComponent> {
	@Override
