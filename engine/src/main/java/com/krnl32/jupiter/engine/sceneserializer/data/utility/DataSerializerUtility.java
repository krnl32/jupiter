...
public class DataSerializerUtility {
	// JOML Math Types
	public static Map<String, Object> serializeVector2f(Vector2fc vec) {
	...
	public static Map<String, Object> serializeVector3f(Vector3fc vec) {
	...
	public static Map<String, Object> serializeVector4f(Vector4fc vec) {
