...
public class SceneSerializer {
	public static Map<String, Object> serialize(Scene scene) {
	...
	@SuppressWarnings("unchecked")
	public static void deserialize(Map<String, Object> data, Scene scene) {
	...
	@SuppressWarnings("unchecked")
	private static void deserializeEntity(Map<String, Object> data, EntityResolver resolver, Map<UUID, Entity> uuidToEntity) {
