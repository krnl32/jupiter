...
public class ComponentSerializerRegistry {
	private static final Map<Class<? extends Component>, ComponentSerializer<? extends Component, ?>> serializers = new HashMap<>();
	...
	public static <T extends Component, R> void register(Class<T> componentType, ComponentSerializer<T, R> serializer) {
	...
	public static <T extends Component, R> ComponentSerializer<T, R> getSerializer(Class<? extends Component> componentType) {
		return (ComponentSerializer<T,R>) serializers.get(componentType);
	}

	@SuppressWarnings("unchecked")
	public static <T extends Component, R> ComponentSerializer<T, R> getSerializer(String componentName) {
	...
	public static boolean hasSerializer(String componentName) {
